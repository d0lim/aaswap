// Package claudeapi is the only place cswap talks to Anthropic over the
...
const (
	...
	// ClientID identifies cswap to the token endpoint. It is not a secret —
...
// errBadResponse marks a body the endpoint sent that cswap could not decode.
//
